...
<section class="contato">
    ...
    <div  class="itemForm">
        <label>Como deveríamos contactá-lo?</label><br>
        <select><option value="" selected="selected">- Selecionar -</option><option value="phone">Telefone</option><option value="email">Mail</option><option value="no">Não há necessidade de entrar em contato comigo</option></select>
    </div>
    <div  class="itemForm">
        <label>Comentários </label>
        <div><textarea cols="60" rows="5"></textarea></div>
    <div class=""><input class="buttonSubmit" type="submit" value="ENVIE SEUS COMENTÁRIOS" /></div></div>
